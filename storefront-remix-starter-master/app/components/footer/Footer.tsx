        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/men" className="text-gray-600 hover:text-gray-900 text-sm">
                  Men's Collection
                </Link>
              </li>
              <li>
                <Link to="/women" className="text-gray-600 hover:text-gray-900 text-sm">
                  Women's Collection
                </Link>
              </li>
              <li>
                <Link to="/new-arrivals" className="text-gray-600 hover:text-gray-900 text-sm">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link to="/sale" className="text-gray-600 hover:text-gray-900 text-sm">
                  Sale
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/store-locator" className="text-gray-600 hover:text-gray-900 text-sm">
                  Store Locator
                </Link>
              </li>
            </ul>
